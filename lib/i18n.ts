...
const translations = {
  en: {
    ...
    agenda: 'Agenda',
    agendaPlaceholder: 'New task...',
    noAgendaItems: 'No tasks yet.',
  ...
  es: {
    ...
    progressLog: 'Progreso',
    noProgress: 'Sin trabajo activo.',
    // Assign Task Modal
    ...
    agenda: 'Agenda',
    agendaPlaceholder: 'Nueva tarea...',
    noAgendaItems: 'Sin tareas.',
